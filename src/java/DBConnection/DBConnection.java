...
public class DBConnection {
    ...
    public static  DataSource getDataSource()
    {
        ...
        try {
            ...
            appConfig.load(new FileInputStream("config/QLCV.properties"));
//            System.out.println("come on: 2 dsfsd" + appConfig);
...
//            System.out.println("DBConnection.DBConnection.getDataSource()");
        } catch (Exception ex) {
...
//            System.out.println("New DB Connection: " + con);
            ...
            System.out.println("Can not get DB Connection: " + sqlex.getMessage());
        }
        return con;
    }
