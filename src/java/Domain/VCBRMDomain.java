...
//   
    public List<VCBHuyDongEntity> danhSachHuyDongVonChuaGan(String param_ngayBaoCao,String thangBaoCao,String loaiTienGui,String cif,String soTaiKhoan, String ten){
        ...
        try {   
            ...
            String l="";
            if(loaiTienGui != ""){ l=l + " and sil.tktype = '"+loaiTienGui+"'";}
            String cif1="";if(cif != ""){ cif1=cif1 + " and sil.cfno = '"+cif+"'";}
            String soTaiKhoan1="";if(soTaiKhoan != ""){ soTaiKhoan1=soTaiKhoan1 + " and sil.TK = '"+soTaiKhoan+"'";}
            String ten1="";if(ten != ""){ ten1=ten1 + " and sil.TEN like '"+ten+"'";}
...
//         System.out.println("tenChucVu: " + tenChucVu);
    ...
    public List<VCBHuyDongEntity> danhSachHuyDongVonDaGan(String param_ngayBaoCao,String thangBaoCao,String loaiTienGui,String cif,String soTaiKhoan,String sellerId,int phongBanId, String ten){
        ...
        try {   
            //nếu không có thuộc tính loại tiền gửi thì 
            String l="";if(loaiTienGui != ""){ l=l + " and sil.tktype = '"+loaiTienGui+"'";}
            String cif1="";if(cif != ""){ cif1=cif1 + " and sil.cfno = '"+cif+"'";}
            String soTaiKhoan1="";if(soTaiKhoan != ""){ soTaiKhoan1=soTaiKhoan1 + " and sil.TK = '"+soTaiKhoan+"'";}
            String sellerId1="";if(sellerId != ""){ sellerId1=sellerId1 + " and map.sellerId = '"+sellerId+"'";}
            String phongBanId1="";if(phongBanId != 0){ phongBanId1=phongBanId1 + " and map.maPhong = '"+phongBanId+"'";}
            String ten1="";if(ten != ""){ ten1=ten1 + " and sil.ten like '"+ten+"'";}
...
//            cs.setString("sellerId", sellerId);
            ...
            {
                while(rs.next())
                {//String CFNO, String TEN, String DIACHI, String SOCMT, String NGAYCAP
                    VCBHuyDongEntity entity = new VCBHuyDongEntity(
                        rs.getString("CFCIFN"),
                        rs.getString("CFSNME"),
                        rs.getString ("CFNA2"),
