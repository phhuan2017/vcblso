 ...
 * @author hayghe
 */
public class CapNhatCongViecServlet extends HttpServlet {
...
//        System.out.println("thoiHan: "+ param_thoiHan);
        ...
        int    param_congViecID=Integer.parseInt(pdp.getParameter("congViecId").trim());
        int    param_trangThaiCongViec=Integer.parseInt(pdp.getParameter("trangThaiCongViec").trim());
//        System.out.println("thoiHan: "+ thoiHan);
        int returnCode=0;
        Connection conn = DBConnectionUser.getConnection();
        VCBDomain vcb = new VCBDomain(conn);
        try {
            returnCode = vcb.capNhatCongViecDomain(param_congViecID,param_tenCongViec,thoiHan,param_cVLienQuan,param_yeuCauCongViec,param_userID,param_trangThaiCongViec);
