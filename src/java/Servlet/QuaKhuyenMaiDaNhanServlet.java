 ...
 * @author adminadLSO
 */
public class QuaKhuyenMaiDaNhanServlet extends HttpServlet {
...
//        int returnCode=0;
        ...
        try {
            ...
            entitys = CV.timQuaKhuyenMaiDaNhanDomain(cif);
...
//            System.out.println(" Quà khuyến mãi  Da nhan ======================>" + arrayObj);
        } catch (Exception ex) {
