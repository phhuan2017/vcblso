 ...
 * @author hayghe
 */
public class capNhatMAPViecServlet extends HttpServlet {
...
//        System.out.println(nguoiId + "hay vãi: "+trangThai);
        int returnCode=0;
        Connection conn = DBConnectionUser.getConnection();
        VCBDomain vcb = new VCBDomain(conn);
        try {
            returnCode = vcb.capNhatMapCongViecDomain(congViecId,nguoiId,trangThai);
