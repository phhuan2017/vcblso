 ...
 * @author hayghe
 */
public class danhSachHuyDongServlet extends HttpServlet {
...
//        System.out.println("===========>  " + theStart + "  " +theLimit);
        ...
        try {
            ...
            entitys = CV.danhSachHuyDongVonChuaGan(param_ngayBaoCao,thangBaoCao,loaiTienGui,cif,soTaiKhoan,ten );
...
//            System.out.println(" huy dong von ======================>" + rootObj.toString());
        } catch (Exception ex) {
