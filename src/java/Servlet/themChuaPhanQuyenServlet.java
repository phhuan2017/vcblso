 ...
 * @author hayghe
 */
public class themChuaPhanQuyenServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int trangThaiId=Integer.parseInt(pdp.getParameter("trangThaiId").trim());
        int returnCode=0;
        Connection conn = DBConnectionUser.getConnection();
        VCBDomain vcb = new VCBDomain(conn);
        try {
            returnCode = vcb.themChuaPhanQuyenDomain(userId,quyenId,userPhanQuyenId,trangThaiId);
