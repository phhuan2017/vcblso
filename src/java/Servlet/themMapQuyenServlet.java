 ...
 * @author hayghe
 */
public class themMapQuyenServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String param_nutId = pdp.getParameter("NUTID").trim();        
        int nutId = param_nutId.length() > 0 ? Integer.parseInt(param_nutId) : -1;
        String param_trangThaiId = pdp.getParameter("TRANGTHAIID").trim();        
        ...
        try {
            returnCode = vcb.themMapQuyenDomain(quyenId,nutId,trangThaiId);
