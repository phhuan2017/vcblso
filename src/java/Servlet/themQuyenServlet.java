...
public class themQuyenServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String param_tenQuyen = pdp.getParameter("tenQuyen").trim();
        String param_moTa=pdp.getParameter("moTa").trim();
//        System.out.println("themquyen:  " + param_moTa);
//        System.out.println("themquyen:  " + quyenId);
//        System.out.println("themquyen:  " + param_tenQuyen);
        ...
        try {
            returnCode = vcb.themQuyenDomain(quyenId,param_tenQuyen,param_moTa,user);
