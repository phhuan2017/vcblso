 ...
 * @author hayghe
 */
public class themYKienServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //congViecId:congViecId,nguoiId:nguoiId,noiDung:noiDung
        String param_noiDung = pdp.getParameter("noiDung").trim();
...
//        System.out.println(param_noiDung+" vao day chua nguoiID: "+ nguoiId);
//        System.out.println("vao day chua congViecId: "+ congViecId);
        int returnCode=0;
        Connection conn = DBConnectionUser.getConnection();
        VCBDomain vcb = new VCBDomain(conn);
        try {
                returnCode = vcb.themYKienDomain(congViecId,nguoiId,param_noiDung);
