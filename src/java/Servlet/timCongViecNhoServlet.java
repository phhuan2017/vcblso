 ...
 * @author hayghe
 */
public class timCongViecNhoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<VCBCongViecNhoEntity> entitys = new ArrayList<VCBCongViecNhoEntity>();
        try {
            VCBDomain CV = new VCBDomain(conn);
            entitys = CV.timCongViecNhoDomain(congViecId);
        ...
        try {
            ...
            for(VCBCongViecNhoEntity item:entitys) {
...
//            System.out.println(" công việc nhỏ======================>" + rootObj);
        } catch (Exception ex) {
