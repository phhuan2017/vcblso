 ...
 * @author adminadLSO
 */
public class timKhachHangKhuyenMaiServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String param_cif=request.getParameter("cif").trim();
        String param_ten=request.getParameter("ten").trim();
        int returnCode=0;
        ...
        try {
            ...
            entitys = CV.timKhachHangKhuyenMai(param_cif,param_ten);
...
//            System.out.println(" tim khach hang khuyen mai ======================>" + arrayObj);
        } catch (Exception ex) {
