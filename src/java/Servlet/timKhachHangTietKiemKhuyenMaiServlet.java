 ...
 * @author adminadLSO
 */
public class timKhachHangTietKiemKhuyenMaiServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            entitys = CV.timKhachHangTietKiemKhuyenMaiDomain(cif);
...
//            System.out.println(" tai khoan tiet kiemádsd ======================>" + arrayObj);
        } catch (Exception ex) {
