 ...
 * @author hayghe
 */
public class timMapViecServlet extends HttpServlet {
...
//        System.out.println("con: " + congViecId);
        ...
        List<VCBMapViecEntity> entitys = new ArrayList<VCBMapViecEntity>();
        try {
            VCBDomain CV = new VCBDomain(conn);
            entitys = CV.timMapViecDomain(congViecId);
        ...
        try {
            ...
            for(VCBMapViecEntity item:entitys) {
...
//            System.out.println(" mapviec" + rootObj);
        } catch (Exception ex) {
