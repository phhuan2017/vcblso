 ...
 * @author hayghe
 */
public class timNguoiPhanCongServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String svl_congViecId=request.getParameter("CONGVIECID").trim();
        int congViecId=0;
        if(svl_congViecId != ""){
            congViecId=Integer.parseInt(svl_congViecId);
        }
        int returnCode=0;
        ...
        try {
            ...
            entitys = CV.timNguoiPhanCongDomain(congViecId);
