 ...
 * @author hayghe
 */
public class timNutServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<VCBNutEntity> entitys = new ArrayList<VCBNutEntity>();
        try {
            VCBDomain CV = new VCBDomain(conn);
            entitys = CV.timNutDomain(quyenId);
...
//            System.out.println(" tim nút======================>" + arrayObj);
        } catch (Exception ex) {
