 ...
 * @author hayghe
 */
public class timPhanQuyenServlet extends HttpServlet {
...
//        System.out.println("request.getParameter(\"USERID\").trim()" + request.getParameter("USERID").trim());
        ...
        try {
            ...
            entitys = CV.timPhanQuyenDomain(userId,1);
