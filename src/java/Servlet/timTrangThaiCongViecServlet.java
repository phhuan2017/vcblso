 ...
 * @author hayghe
 */
public class timTrangThaiCongViecServlet extends HttpServlet {
...
//        String tenQuyen=request.getParameter("TENQUYEN").trim();
        ...
        List<VCBTrangThaiCongViecEntity> entitys = new ArrayList<VCBTrangThaiCongViecEntity>();
        try {
            VCBDomain CV = new VCBDomain(conn);
            entitys = CV.timTrangThaiCongViecDomain();
        ...
        try {
            ...
            for(VCBTrangThaiCongViecEntity item:entitys) {
