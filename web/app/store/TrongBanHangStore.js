Ext.define(('vcb.store.TrongBanHangStore'),{
    extend:'Ext.data.Store',
    fields:['tenThongTin'],
    data : [
         {tenThongTin: 'Nguyễn Văn An'},
         {tenThongTin: 'Hoàng Thị Lan'},
         {tenThongTin: 'Trịnh Ngọc Ngà'},
         {tenThongTin: 'Lê Đức Anh'},
         {tenThongTin: 'Nguyễn Trọng Nam'},
         {tenThongTin: 'Trần Thanh Bình'},
         {tenThongTin: 'Lê Đại Đồng'}
     ]
