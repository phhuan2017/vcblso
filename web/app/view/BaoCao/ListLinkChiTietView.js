...
//                                        flex: 0.5,
                                                                ...
                                                                callback: function(records, operation, success) {
                                                                    ...
                                                                    if(kt==1){
                                                                        if(maChuongTrinh=='Mã tự sinh không cần điền'){// tức là đang thêm mới
                                                                            Core.themChuongTrinh(-1,tenChuongTrinh,URL,ghiChu,nguoiId,function(options,success,response){
                                ...
                                //                                                    console.log(response);
                                                                            ...
                                                                            Core.themChuongTrinh(maChuongTrinh,tenChuongTrinh,URL,ghiChu,nguoiId,function(options,success,response){
                                                                                if (success) {//kiem tra ket noi thanh cong khong 
                                                                                    response = Ext.decode(response.responseText);
                                //                                                    console.log(response);
                                                                                    if(response.success==true){// kiểm tra user tồn tại hay chưa 
