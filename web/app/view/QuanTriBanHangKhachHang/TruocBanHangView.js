Ext.define(('vcb.view.QuanTriBanHangKhachHang.TruocBanHangView'), {
    extend:'Ext.form.Panel',
    itemId: 'TruocBanHangView',
    id:'TruocBanHangView',
    xtype: 'TruocBanHangView',
    requires:[
        'vcb.view.QuanTriBanHangKhachHang.TruocBanHangChiTietGridView',
    ],
    config:{
        items:[
            {
